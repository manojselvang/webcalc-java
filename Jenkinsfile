    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/manojselvang/webcalc-java.git'
            }
        }
       ...
       //     steps {
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://192.168.70.134:8081/')], contextPath: null, war: '**/*.war'
            }
        }
